...
<template>
  <header class="topbar">
    <button class="iconbtn menu-toggle" type="button" aria-label="Toggle navigation"
    ...
    <span class="topbar__base">
      <span class="label">Base</span>
      <span class="host">{{ API_HOST }}</span>
    </span>

    <span class="topbar__spacer" />

    <button class="iconbtn support-btn" type="button" aria-label="Support this project"
    ...
    <button class="iconbtn" type="button" aria-label="Toggle colour theme" @click="toggle">
